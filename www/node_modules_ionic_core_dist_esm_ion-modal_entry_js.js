...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,C_Users_CRISS_Desktop_ModuloMovil_Git_mMovil_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (el, animation) {
    /**
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_Users_CRISS_Desktop_ModuloMovil_Git_mMovil_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
